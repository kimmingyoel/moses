...
/* ─────────────────────────────────────────────────────────────
 * Shared doodle props.
 * Doodle shapes use the crayon wobble filter. Any SVG text is kept outside
 * that filtered layer so labels stay crisp.
 * ───────────────────────────────────────────────────────────── */
...
const crayonWobbleStyle = { filter: "url(#crayonWobble)" };
...
export function DoodleReceipt({ tone = "dark", ...rest }: DoodleProps) {
  ...
  return (
    <svg viewBox="0 0 96 140" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        <path
...
export function DoodleCoin({ tone = "dark", ...rest }: DoodleProps) {
  ...
  return (
    <svg viewBox="0 0 60 60" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        <circle cx="30" cy="30" r="24" stroke={c} strokeWidth="2.8" fill="#e3e3e3" />
...
export function DoodleCoinSmall({ tone = "dark", ...rest }: DoodleProps) {
  ...
  return (
    <svg viewBox="0 0 40 40" fill="none" style={{ filter: "url(#crayonWobble)" }} {...rest}>
      <circle cx="20" cy="20" r="15" stroke={c} strokeWidth="2.2" fill="#cfcfcf" />
...
export function DoodlePencil({ tone = "dark", ...rest }: DoodleProps) {
  ...
  return (
    <svg viewBox="0 0 140 36" fill="none" style={{ filter: "url(#crayonWobble)" }} {...rest}>
      {/* body */}
      <path d="M20 10 L110 10 L110 26 L20 26 Z" stroke={c} strokeWidth="2.4" fill="#e3e3e3" />
      {/* tip cone */}
      <path d="M20 10 L4 18 L20 26 Z" stroke={c} strokeWidth="2.4" fill="#f2f2f2" />
      {/* lead */}
      <path d="M4 18 L12 14 M4 18 L12 22" stroke={c} strokeWidth="1.6" strokeLinecap="round" />
      {/* ferrule */}
      <path d="M110 8 L126 8 L126 28 L110 28 Z" stroke={c} strokeWidth="2.4" fill="#bababa" />
      <path d="M114 8 L114 28 M118 8 L118 28 M122 8 L122 28" stroke={c} strokeWidth="1.2" />
      {/* eraser */}
      <path d="M126 8 Q134 8 134 18 Q134 28 126 28 Z" stroke={c} strokeWidth="2.4" fill="#858585" />
      {/* wood grain */}
...
export function DoodleCalculator({ tone = "dark", ...rest }: DoodleProps) {
  const c = useStroke(tone);
  return (
    <svg viewBox="0 0 90 110" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        <path d="M8 8 L80 6 L82 100 L10 102 Z" stroke={c} strokeWidth="2.6" strokeLinejoin="round" fill="#cfcfcf" />
        {/* display */}
        <path d="M16 16 L74 14 L75 32 L17 33 Z" stroke={c} strokeWidth="2" strokeLinejoin="round" fill="#f2f2f2" />
        {/* buttons */}
        {[0, 1, 2, 3].map((row) =>
          [0, 1, 2, 3].map((col) => (
            <circle
...
export function DoodleCoffee({ tone = "dark", ...rest }: DoodleProps) {
  const c = useStroke(tone);
  return (
    <svg viewBox="0 0 110 130" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        {/* steam */}
        ...
        {/* cup */}
        <path d="M16 54 L92 52 L86 110 Q86 118 76 118 L32 118 Q22 118 22 110 Z" stroke={c} strokeWidth="2.8" strokeLinejoin="round" fill="#e3e3e3" />
        {/* handle */}
        ...
        {/* price tag */}
        <path d="M72 100 L102 96 L106 118 L76 122 Z" stroke={c} strokeWidth="2.2" strokeLinejoin="round" fill="#f2f2f2" />
        <circle cx="79" cy="106" r="2" stroke={c} strokeWidth="1.4" fill="#f2f2f2" />
      </g>
...
export function DoodleSplitters({ tone = "dark", ...rest }: DoodleProps) {
  const c = useStroke(tone);
  return (
    <svg viewBox="0 0 160 120" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        {/* left figure */}
        <circle cx="30" cy="26" r="11" stroke={c} strokeWidth="2.4" fill="#f2f2f2" />
        ...
        {/* right figure */}
        <circle cx="130" cy="28" r="11" stroke={c} strokeWidth="2.4" fill="#f2f2f2" />
        ...
        <path d="M62 50 L98 50 L100 78 L96 76 L92 78 L88 76 L84 78 L80 76 L76 78 L72 76 L68 78 L64 76 Z" stroke={c} strokeWidth="2" strokeLinejoin="round" fill="#f2f2f2" />
...
export function DoodleCoupon({ tone = "dark", ...rest }: DoodleProps) {
  const c = useStroke(tone);
  return (
    <svg viewBox="0 0 120 60" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        <path d="M6 12 L114 8 L116 50 L8 54 Z" stroke={c} strokeWidth="2.4" strokeLinejoin="round" fill="#e3e3e3" />
...
export function DoodlePiggyBank({ tone = "dark", ...rest }: DoodleProps) {
  const c = useStroke(tone);
  return (
    <svg viewBox="0 0 130 100" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        {/* body */}
        <path d="M14 58 Q14 32 50 30 Q90 28 110 40 Q124 48 124 64 Q124 80 110 84 Q110 92 102 94 L96 88 Q80 92 60 90 L56 96 L48 96 L46 90 Q26 84 18 76 Q14 70 14 58 Z" stroke={c} strokeWidth="2.8" strokeLinejoin="round" fill="#cfcfcf" />
        {/* snout */}
        <ellipse cx="14" cy="56" rx="6" ry="8" stroke={c} strokeWidth="2.2" fill="#bababa" />
        <circle cx="12" cy="54" r="1.5" fill={c} />
        <circle cx="12" cy="60" r="1.5" fill={c} />
        {/* eye */}
        <circle cx="38" cy="46" r="2.4" fill={c} />
        <circle cx="38.5" cy="45.5" r="0.8" fill="#f2f2f2" />
        {/* ear */}
        <path d="M52 26 L48 38 L60 32 Z" stroke={c} strokeWidth="2.2" strokeLinejoin="round" fill="#bababa" />
        {/* slot */}
        ...
        {/* coin going in */}
        <circle cx="78" cy="10" r="6" stroke={c} strokeWidth="2" fill="#e3e3e3" />
      </g>
...
export function DoodleBill({ tone = "dark", ...rest }: DoodleProps) {
  const c = useStroke(tone);
  return (
    <svg viewBox="0 0 130 60" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        <path d="M6 14 L122 8 L124 50 L8 54 Z" stroke={c} strokeWidth="2.6" strokeLinejoin="round" fill="#e3e3e3" />
...
export function DoodleSpeechBubble({ tone = "dark", ...rest }: DoodleProps) {
  const c = useStroke(tone);
  return (
    <svg viewBox="0 0 100 80" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        <path d="M10 14 Q10 6 22 6 L82 6 Q94 6 94 18 L94 46 Q94 56 82 56 L34 56 L22 72 L24 56 Q10 56 10 46 Z" stroke={c} strokeWidth="2.4" strokeLinejoin="round" fill="#f2f2f2" />
      </g>
...
export function DoodleMagnifier({ tone = "dark", ...rest }: DoodleProps) {
  ...
  return (
    <svg viewBox="0 0 80 80" fill="none" style={{ filter: "url(#crayonWobble)" }} {...rest}>
      <circle cx="32" cy="32" r="22" stroke={c} strokeWidth="3" fill="#f2f2f2" />
...
export function DoodleCheck({ tone = "dark", ...rest }: DoodleProps) {
  ...
  return (
    <svg viewBox="0 0 40 40" fill="none" style={{ filter: "url(#crayonWobble)" }} {...rest}>
      <circle cx="20" cy="20" r="16" stroke={c} strokeWidth="2.6" fill="#e3e3e3" />
...
export function DoodleRibbon({ tone = "dark", children, ...rest }: DoodleProps & { children?: React.ReactNode }) {
  const c = useStroke(tone);
  return (
    <svg viewBox="0 0 280 70" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        <path
  ...
  return (
    <svg viewBox="0 0 60 60" fill="none" {...rest}>
      <g style={{ transformOrigin: "20px 56px" }} className="animate-pencil">
        <path d="M14 16 L22 16 L22 50 L14 50 Z" stroke={c} strokeWidth="2" fill="#e3e3e3" />
        <path d="M14 50 L22 50 L18 56 Z" stroke={c} strokeWidth="2" strokeLinejoin="round" fill="#2a2a2a" />
        <path d="M14 16 L22 16 L22 12 L14 12 Z" stroke={c} strokeWidth="2" fill="#bababa" />
      </g>
...
export function DoodleAvatar({ name, tone = "dark", size = 56, ...rest }: DoodleProps & { name: string; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 60 60" fill="none" {...rest}>
      <g style={crayonWobbleStyle}>
        <circle cx="30" cy="30" r="25" stroke={c} strokeWidth="2.8" fill="#e3e3e3" />
